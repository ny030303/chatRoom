...
public class LoginController extends MasterController {
	...
	public void loginProcess() {
		...
		if(user != null) {
//			Main.app.masterController.reload();
			Main.app.slideOut(loginPane);
			// main 보이느느는 곳
			Main.app.setLoginUser(user);
		}else {
	...
	private UserVO checkLogin(String id, String pw) {
		...
		String sql = "SELECT * FROM mafia_user WHERE id = ? AND pass = PASSWORD(?)";
//		String sql = "SELECT * FROM diary_users WHERE id = ? AND pass = ?";
