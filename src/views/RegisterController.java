...
public class RegisterController extends MasterController{
	...
	public void register() {
		...
		ResultSet rs = null;
		String sqlExist = "SELECT * FROM mafia_user WHERE id = ?"; //해당 유저가 존재하는지 확인하기 위한 sql
		String sqlInsert = "INSERT INTO mafia_user(`id`, `name`, `pass`, `info`) VALUES (?, ?, PASSWORD(?), ?)";
		...
		try {
			...
			Main.app.slideOut(getRoot()); //루트를 잡아서 슬라이드 아웃 시킴.
